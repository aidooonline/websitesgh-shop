...
function wghs_sticky_order_bar() {
	...
	<div class="wghs-orderbar lg:hidden" role="region" aria-label="<?php esc_attr_e( 'Order', 'wghshop' ); ?>">
		...
		?>
		<?php if ( $in_stock ) : ?>
			<a class="wghs-orderbar__half wghs-orderbar__half--primary" href="<?php echo esc_url( $cart_url ); ?>" rel="nofollow" data-wghs-event="orderbar_get_it_now" data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">
				<span class="wghs-orderbar__label"><?php esc_html_e( 'Get it now', 'wghshop' ); ?></span>
